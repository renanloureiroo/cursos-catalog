...
public interface CoursesControllerSwaggerDocs {
  ...
  @Operation(
    ...
    description = "Cria um novo curso no catálogo com nome e categoria"
  )
  @ApiResponses(value = {
    @ApiResponse(
      responseCode = "201", 
  ...
  @Operation(
    ...
    description = "Lista todos os cursos disponíveis no catálogo"
  )
  @ApiResponses(value = {
    @ApiResponse(
      responseCode = "200", 
      ...
      content = @Content(
        mediaType = MediaType.APPLICATION_JSON_VALUE,
        schema = @Schema(implementation = ListCoursesResponseDTO.class)
      )
    )
  }) 
